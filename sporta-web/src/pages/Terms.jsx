...
// Every statement here restates something the site already commits to
// elsewhere — same-day delivery and the accepted cards on /about, the 14-day
// window on /returns, the contact details on /contact — so the terms cannot
...
const INTRO = {
  ...
  ar: 'تنظّم هذه الشروط الشراء من موقع sporta.com.kw، وبإتمامك الطلب فإنك توافق عليها.',
}

const SECTIONS = [
  {
    h: { en: '1. Who we are', ar: '١. من نحن' },
    p: [{
      en: 'Sporta (سبورتا) is a sportswear retailer in Kuwait, selling online at www.sporta.com.kw. You can reach us on WhatsApp at +965 2209 1914 or by email at cs@sporta.com.kw.',
      ar: 'سبورتا متجر ملابس رياضية في الكويت، يبيع عبر الإنترنت على www.sporta.com.kw. يمكنك التواصل معنا عبر واتساب ‎+965 2209 1914 أو بالبريد الإلكتروني cs@sporta.com.kw.',
    }],
  },
  {
  ...
  {
    h: { en: '6. Using this site', ar: '٦. استخدام الموقع' },
    p: [{
      en: 'Product photographs, text, the Sporta name and the Sporta logo belong to us or to the brands we stock, and may not be copied for commercial use. Brand names are the property of their respective owners.',
      ar: 'صور المنتجات والنصوص واسم سبورتا وشعارها ملك لنا أو للماركات التي نوفرها، ولا يجوز نسخها لأغراض تجارية. وأسماء الماركات ملك لأصحابها.',
    }, {
      en: 'Please do not attempt to disrupt the site, place fraudulent orders, or access accounts and data that are not yours.',
      ar: 'يُرجى عدم محاولة تعطيل الموقع أو تقديم طلبات احتيالية أو الوصول إلى حسابات وبيانات لا تخصّك.',
    }],
  },
  {
    h: { en: '7. Changes and governing law', ar: '٧. التعديلات والقانون الواجب التطبيق' },
    p: [{
      en: 'We may update these terms; the date at the top shows when the wording last changed. The terms in force are the ones published when you place your order.',
      ar: 'قد نُحدّث هذه الشروط، ويوضّح التاريخ أعلاه آخر تعديل على الصياغة. والشروط السارية هي المنشورة وقت تقديمك للطلب.',
    }, {
      en: 'These terms are governed by the laws of the State of Kuwait, and the courts of Kuwait have jurisdiction over any dispute.',
      ar: 'تخضع هذه الشروط لقوانين دولة الكويت، وتختص محاكم الكويت بالنظر في أي نزاع.',
    }],
  },
]
...
export default function Terms() {
  return (
    <LegalPage
      path="/terms"
      titleKey={{ en: 'Terms & conditions', ar: 'الشروط والأحكام' }}
      updated={UPDATED}
      intro={INTRO}
      sections={SECTIONS}
    />
