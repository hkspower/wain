...
const b64 = await page.evaluate(async () => {
  ...
  for (let i=0;i<modes.length;i++){
    const g = window.__grnBuildCar({ body: 0xc1121f, style:"sedan", kit:"street",
      lengthM: 4.7, finish: modes[i] });
    scene.add(g);
...
writeFileSync("press/shop/finish.png", Buffer.from(b64,"base64"));
console.log("press/shop/finish.png");
await browser.close();
