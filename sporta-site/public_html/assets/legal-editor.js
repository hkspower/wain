...
(function () {
  ...
  var CSS = ''
    + '.sle{border:1px solid #e2e8f0;border-radius:12px;padding:16px;margin:20px 0;background:#fff}'
    + '.sle-h{margin:0 0 4px;font-size:16px;font-weight:700;color:#0f172a}'
    + '.sle-sub{margin:0 0 14px;color:#64748b;font-size:13px;line-height:1.5}'
    ...
    + '.sle-label{font-size:13px;font-weight:600;color:#0f172a}'
    + '.sle-hint{font-size:12px;color:#64748b;line-height:1.4}'
    + '.sle-input,.sle-area{padding:8px 10px;border-radius:8px;border:1px solid #cbd5e1;'
