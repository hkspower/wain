...
(function () {
  ...
  var CSS = ''
    + '.spc{border:1px solid #e2e8f0;border-radius:12px;padding:16px;margin:20px 0;background:#fff}'
    + '.spc-h{margin:0 0 4px;font-size:16px;font-weight:700;color:#0f172a}'
    + '.spc-sub{margin:0 0 14px;color:#64748b;font-size:13px;line-height:1.5}'
    ...
    + '.spc-label{font-size:13px;font-weight:600;color:#0f172a}'
    + '.spc-hint{font-size:12px;color:#64748b;line-height:1.4}'
    + '.spc-input{padding:8px 10px;border-radius:8px;border:1px solid #cbd5e1;'
