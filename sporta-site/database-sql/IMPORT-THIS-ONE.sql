...
-- ========================================================== return requests
--
-- Appended by hand. The header above names scripts/make-install-sql.mjs as
-- the generator; that script belonged to the website's own repository and
-- went with it, so this file is now maintained directly. The section below
-- is 7-returns.sql verbatim, minus its own header and 'set names'.
