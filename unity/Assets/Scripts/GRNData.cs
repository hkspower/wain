...
public static class GRNData
{
    ...
    public static readonly Rival[] Rivals =
    {
        ...
        new Rival {
            ...
            IntroAr = "تبي تسابقني؟ يلا نشوف شطارتك",
        ...
        new Rival {
            ...
            IntroAr = "وصلت للنهاية... بس الشبح ما ينغلب",
    ...
    public static readonly Car[] Cars =
    {
        new Car {
            ...
            Paint = Hex(0x0B0A0D), Style = BodyStyle.GTR, AttackKit = true, Trike = true, Drive = Drivetrain.RWD,
        ...
        new Car {
            ...
            Paint = Hex(0x3B2A5A), Style = BodyStyle.ZX, AttackKit = true, Trike = false, Drive = Drivetrain.AWD,
        ...
        new Car {
            ...
            Paint = Hex(0xF2B90D), Style = BodyStyle.RX7, AttackKit = true, Trike = false, Drive = Drivetrain.RWD,
        ...
        new Car {
            ...
            Paint = Hex(0xB8860B), Style = BodyStyle.ZX, AttackKit = true, Trike = false, Drive = Drivetrain.RWD,
        ...
        new Car {
            ...
            Paint = Hex(0xC1121F), Style = BodyStyle.ZX, AttackKit = true, Trike = false, Drive = Drivetrain.RWD,
        ...
        new Car {
            ...
            Paint = Hex(0x1F2933), Style = BodyStyle.Super, AttackKit = true, Trike = false, Drive = Drivetrain.AWD,
        ...
        new Car {
            ...
            Paint = Hex(0xF2F2EE), Style = BodyStyle.Pony, AttackKit = false, Trike = false, Drive = Drivetrain.RWD,
        ...
        new Car {
            ...
            Paint = Hex(0x3F66C4), Style = BodyStyle.GTR, AttackKit = true, Trike = false, Drive = Drivetrain.AWD,
        ...
        new Car {
            ...
            Paint = Hex(0xD7263D), Style = BodyStyle.RX7, AttackKit = false, Trike = false, Drive = Drivetrain.RWD,
        ...
        new Car {
            ...
            Paint = Hex(0xC1272D), Style = BodyStyle.ZX, AttackKit = false, Trike = false, Drive = Drivetrain.AWD,
        ...
        new Car {
            ...
            Paint = Hex(0xCB2027), Style = BodyStyle.Hatch, AttackKit = false, Trike = false, Drive = Drivetrain.FWD,
        ...
        new Car {
            ...
            Paint = Hex(0xB84DD6), Style = BodyStyle.Sedan, AttackKit = false, Trike = false, Drive = Drivetrain.FWD,
        ...
        new Car {
            ...
            Paint = Hex(0xF5C211), Style = BodyStyle.Sedan, AttackKit = false, Trike = false, Drive = Drivetrain.FWD,
        ...
        new Car {
            ...
            Paint = Hex(0xDFE3E8), Style = BodyStyle.Sedan, AttackKit = false, Trike = false, Drive = Drivetrain.FWD,
        ...
        new Car {
            ...
            Paint = Hex(0x6E7F8D), Style = BodyStyle.Pickup, AttackKit = false, Trike = false, Drive = Drivetrain.RWD,
        ...
        new Car {
            ...
            Paint = Hex(0x16A34A), Style = BodyStyle.Hatch, AttackKit = false, Trike = false, Drive = Drivetrain.FWD,
        ...
        new Car {
            ...
            Paint = Hex(0xF2F4F7), Style = BodyStyle.Sedan, AttackKit = false, Trike = false, Drive = Drivetrain.RWD,
    ...
    public static class Rig
    {
        ...
        public const float DriverLeanRefAccel = 14f;
        public const float DriverFoldRefAccel = 10f;
        public const float DriverFoldSpikeK = 2.5f;
        public const float DriverTorsoK = 190f;
        public const float DriverTorsoC = 15f;
        public const float DriverNeckK = 355f;
        ...
        public const float DriverPedalClutchX = 0.21f;
        public const float DriverPedalRestX = 0.31f;
        public const float DriverFootSwapRate = 14f;
        public const float DriverHeelToeReach = 0.45f;
        public const float DriverHeelToeBrake = 0.2f;
        public const float DriverClutchRate = 20f;
        ...
        public const float PlantShrubK = 160f;
        public const float PlantShrubC = 9f;
        public const float PlantPalmK = 25f;
        public const float PlantPalmC = 3.5f;
        public const float PlantMaxLean = 0.9f;
        public const float PlantGustBase = 0.05f;
        public const float PlantGustAmp = 0.03f;
        public const float PlantGustRate = 0.37f;
        public const float PlantWindTurnRate = 0.05f;
        public const float PlantWindK = 0.5f;
        public const float PlantSwayHz = 0.14f;
        public const float PlantSwayK = 0.5f;
        public const float PlantFrontAmp = 0.6f;
        public const float PlantFrontRate = 0.6f;
        public const float PlantFrontK = 0.08f;
        public const float PlantWakeR = 9f;
        public const float PlantWakeRefSpeed = 55f;
        public const float PlantWakeK = 0.55f;
        public const float PlantNoseM = 3f;
        public const float PlantSuctionK = 0.3f;
        public const float PlantDragK = 0.25f;
        public const float PlantTailLenM = 12f;
        public const float PlantPalmWakeK = 0.35f;
        public const float PlantArcDrop = 0.5f;
        public const float PlantNormalGain = 0.8f;
    ...
    public static readonly Part[] Parts =
    {
        ...
        new Part { Id = "diff-open", Cat = "diff", Price = 0 },
        new Part { Id = "diff-spool", Cat = "diff", Price = 900 },
        new Part { Id = "lsd", Cat = "diff", Price = 1300 },
        new Part { Id = "diff-clutch", Cat = "diff", Price = 2400 },
