...
(function () {
  ...
  var TOPICS = [
    ...
    },
    {
      ...
      a: 'نعم، خدمة «اشترِ لي» متاحة: يدفع الكابتن قيمة المشتريات وتستردّها عند التسليم مع رسوم خدمة. راسلنا على واتساب لتفاصيل الرسوم على طلبك.',
      handoff: true,
      src: '#faq',
    },
    {
    ...
    },
    {
      ...
      q: 'كيف أتواصل معكم؟',
      a: 'أسرع طريق هو واتساب — يردّ عليك فريق خدمة العملاء. وتجد وسائل التواصل كلها في قسم «اطلب سائق موصول» أسفل الصفحة.',
      handoff: true,
      src: '#order',
    },
  ];
