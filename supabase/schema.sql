...
-- ---------------------------------------------------------------------------
-- Seed: the 52 places the site ships with today.
-- ---------------------------------------------------------------------------
...
values
  ...
  ('marina-beach', 'Marina Beach & Crescent', 'شاطئ المارينا', 'outdoors', 'Salmiya', 'السالمية', 29.3411, 48.0673, 4.5, 1, '🏖️', 'رمل ناعم ومطاعم على بحر السالمية.', 'شاطئ نظيف ومناسب للعوائل، مربوط بمول المارينا بجسر مشاة. اسبح أو استأجر كاياك، أو بس تمشّى على الكريسنت وقت الغروب واختر كافيه على البحر.', ARRAY['سباحة وكاياك', 'كافيهات على الواجهة', 'ممشى المارينا كريسنت']::text[], 'العصر المتأخر', 'outdoor', 'من أكتوبر لأبريل', ARRAY['بحر', 'سباحة', 'كاياك', 'ممشى', 'عوائل', 'غروب']::text[], true, 100),
  ...
  ('marina-mall', 'Marina Mall', 'مارينا مول', 'shopping', 'Salmiya', 'السالمية', 29.3395, 48.0678, 4.3, 2, '🛍️', 'مول على البحر مربوط بالشاطئ والكريسنت.', 'مول على واجهة السالمية البحرية، مربوط بشاطئ المارينا وممشى الكريسنت بجسر مشاة. محلات ومطاعم مطلّة على الماء، وأسهل طلعة تجمع بين التسوّق والبحر.', ARRAY['مربوط بشاطئ المارينا', 'مطاعم على الواجهة', 'جسر مشاة للشاطئ']::text[], 'العصر، وبعدها مشية على البحر', 'mixed', 'طول السنة، والشاطئ أحلى بالشتاء', ARRAY['مكيّف', 'بحر', 'كافيهات', 'مطاعم', 'عوائل', 'ممشى']::text[], false, 240),
  ('mall-360', '360 Mall', 'مجمع ٣٦٠', 'shopping', 'Zahra', 'الزهراء', 29.2707, 47.9459, 4.4, 3, '🛒', 'مول راقي على الدائري السادس.', 'مجمّع أنيق فيه ماركات عالمية ومطاعم وسينما ونادي رياضي، وتصميمه الداخلي مفتوح وفيه نخيل تحت الإضاءة الطبيعية. أهدأ من الأفنيوز وأرقى في المحلات.', ARRAY['ماركات عالمية', 'تصميم داخلي مفتوح', 'أقل زحمة']::text[], 'أيام الأسبوع، بعد العصر', 'indoor', 'طول السنة — مكيّف', ARRAY['مكيّف', 'ماركات', 'سينما', 'هدوء', 'راقي', 'مطاعم', 'رياضة']::text[], false, 250),
  ...
  ('salhia-complex', 'Salhia Complex', 'الصالحية', 'shopping', 'Kuwait City', 'مدينة الكويت', 29.3767, 47.9884, null, 3, '💎', 'أرقى مجمع في وسط المدينة، ومن أقدمها.', 'مجمع تسوّق راقي في قلب العاصمة، مفتوح من السبعينات ومربوط بفنادق ومكاتب. الماركات فيه عالمية والأجواء أهدى من المولات الكبيرة، وهو أسهل خيار إذا انت بوسط المدينة.', ARRAY['ماركات عالمية', 'أهدى من المولات الكبيرة', 'بقلب العاصمة']::text[], 'أيام الأسبوع، بعد العصر', 'indoor', 'طول السنة — مكيّف', ARRAY['مكيّف', 'ماركات', 'راقي', 'تسوّق', 'هدوء', 'مطاعم']::text[], false, 440),
  ('dickson-house', 'Dickson House', 'بيت ديكسون', 'culture', 'Sharq', 'شرق', 29.3823, 48.0009, null, 1, '🏚️', 'بيت طيني على شارع الخليج، من أيام ما كانت الكويت سور.', 'بيت المعتمد البريطاني هارولد ديكسون، ومن أقدم البيوت الباقية على الواجهة البحرية. انرمّم وصار مركز ثقافي يعرض صور ووثائق من الكويت قبل النفط. الزيارة قصيرة، بس تعطيك إحساس بالمدينة القديمة ما يعطيك إياه متحف كبير.', ARRAY['بيت تراثي مرمّم', 'صور ووثائق قديمة', 'على شارع الخليج']::text[], 'العصر، أيام الأسبوع', 'indoor', 'طول السنة', ARRAY['تراث', 'تاريخ', 'بيت قديم', 'هدوء', 'تصوير', 'متحف']::text[], false, 450),
  ('al-shaab-beach', 'Al Shaab Beach', 'شاطئ الشعب', 'outdoors', 'Al Shaab', 'الشعب', 29.3466, 48.0625, null, 1, '🏖️', 'أقرب بحر لأهل العاصمة والسالمية.', 'شاطئ رملي عام على شارع الخليج، بين العاصمة والسالمية. فيه ممشى وجلسات على الواجهة، والناس تجي له بعد الدوام يتمشون ويقعدون على البحر بدون ما يطلعون برا المدينة.', ARRAY['رمل وممشى', 'أقرب بحر للعاصمة', 'جلسات على الواجهة']::text[], 'العصر لين الغروب', 'outdoor', 'من أكتوبر لأبريل', ARRAY['بحر', 'رمل', 'ممشى', 'عوائل', 'غروب', 'مشي']::text[], false, 460),
  ('kuwait-fairground', 'Kuwait International Fairground', 'معرض الكويت الدولي', 'family', 'Mishref', 'مشرف', 29.2762, 48.0693, null, 2, '🎪', 'وين تصير المعارض الكبيرة كلها.', 'أرض المعارض في مشرف، وفيها صالات كبيرة تستضيف معرض الكتاب ومعارض السيارات والأثاث وغيرها طول السنة. الطلعة هني تعتمد على الجدول: إذا فيه معرض تصير طلعة يوم كامل للعائلة، وإذا ما فيه فما فيه شي تشوفه.', ARRAY['صالات معارض كبيرة', 'معرض الكتاب', 'مواقف واسعة']::text[], 'وقت المعارض — راجع الجدول', 'indoor', 'طول السنة — مكيّف', ARRAY['مكيّف', 'معارض', 'عوائل', 'عيال', 'يوم كامل', 'مواقف']::text[], false, 470),
  ('souq-al-safafeer', 'Souq Al Safafeer', 'سوق الصفافير', 'shopping', 'Kuwait City', 'مدينة الكويت', 29.3757, 47.9884, null, 1, '🪔', 'آخر سوق نحّاسين في الكويت.', 'سوق صغير ملاصق للمباركية، وفيه الصفافير — صنّاع النحاس — يشتغلون بيدهم مثل زمان. دلال قهوة وصواني وأواني نحاس، وأغلبها مشغول بالمكان نفسه. لفّة قصيرة، بس ما تلقاها بمكان ثاني.', ARRAY['صناعة النحاس باليد', 'دلال قهوة وصواني', 'ملاصق للمباركية']::text[], 'الصبح، أيام الأسبوع', 'mixed', 'من أكتوبر لأبريل، وبالليل صيفاً', ARRAY['تراث', 'حرف', 'نحاس', 'هدايا', 'تصوير', 'تسوّق', 'رخيص']::text[], false, 480),
  ('sheikh-jaber-causeway', 'Sheikh Jaber Causeway', 'جسر الشيخ جابر', 'landmarks', 'Subiya', 'الصبية', 29.4361, 47.9086, null, 1, '🌉', 'ستة وثلاثين كيلومتر فوق البحر.', 'من أطول الجسور البحرية في العالم، يربط العاصمة بالصبية شمالاً. الطلعة هني هي السواقة نفسها — بحر من الجهتين طول الطريق، وفيه جزيرة صناعية بالنص فيها محطة خدمات. أحلى وقت لها وقت الغروب.', ARRAY['٣٦ كم فوق البحر', 'جزيرة صناعية بالنص', 'غروب من فوق الماي']::text[], 'وقت الغروب', 'outdoor', 'طول السنة — انت بالسيارة', ARRAY['سواقة', 'بحر', 'جسر', 'غروب', 'تصوير', 'معلم', 'طلعة']::text[], false, 490),
  ('al-fanar-mall', 'Al Fanar Mall', 'مجمع الفنار', 'shopping', 'Salmiya', 'السالمية', 29.3378, 48.0797, null, 2, '🛍️', 'مجمع مفتوح على بحر السالمية.', 'مجمع بتصميم مفتوح على شارع الخليج بالسالمية، فيه محلات ومطاعم وساحة مكشوفة. أصغر وأهدى من مارينا مول اللي جنبه، ويجمع بين التسوّق والقعدة على البحر بنفس الطلعة.', ARRAY['تصميم مفتوح', 'على شارع الخليج', 'أهدى من المولات الكبيرة']::text[], 'بعد العصر', 'mixed', 'أحلى من أكتوبر لأبريل', ARRAY['تسوّق', 'بحر', 'مطاعم', 'كافيهات', 'هدوء', 'ممشى']::text[], false, 500),
  ('modern-art-museum', 'Museum of Modern Art', 'متحف الفن الحديث', 'culture', 'Kuwait City', 'مدينة الكويت', 29.3746, 47.9931, null, 1, '🖼️', 'الفن الكويتي الحديث، في مدرسة من الثلاثينات.', 'متحف صغير في مبنى مدرسة قديمة بوسط المدينة، يعرض أعمال فنانين كويتيين وخليجيين من منتصف القرن لين اليوم. هادي ومنسّق، ويكمّل زيارة المتاحف اللي حواليه في نفس اللفّة.', ARRAY['فن كويتي وخليجي', 'مبنى مدرسة مرمّم', 'هادي ومنسّق']::text[], 'العصر، أيام الأسبوع', 'indoor', 'طول السنة', ARRAY['فن', 'متحف', 'هدوء', 'معارض', 'تصوير', 'مكيّف']::text[], false, 510)
