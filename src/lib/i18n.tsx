  ...
  ar: {
    ...
    account: {
      ...
      auth: {
        ...
        registerHint: 'البريد الإلكتروني وكلمة المرور فقط — يمكنك إكمال بياناتك لاحقًا عند الطلب.',
        email: 'البريد الإلكتروني',
        ...
        password_too_short: 'كلمة المرور يجب أن تكون ١٢ حرفًا على الأقل.',
  ...
  en: {
    ...
    account: {
      ...
      auth: {
        ...
        registerHint: 'Just an email and a password — you can add the rest when you place an order.',
        email: 'Email',
        password: 'Password',
        signIn: 'Sign in',
