...
export const places: Place[] = [
  ...
  },
  {
    ...
    highlightsAr: ["سباحة وكاياك", "كافيهات على الواجهة", "ممشى المارينا كريسنت"],
     ...
     --------------------------------------------------------------------- */
  {
    ...
    priceLevel: 2,
    emoji: "🛍️",
    taglineAr: "مول على البحر مربوط بالشاطئ والكريسنت.",
    descriptionAr:
    ...
    // The Crescent connection lives in the description, not here. highlightsAr
    // feeds the search index at keyword weight, so naming a NEIGHBOUR's proper
    // noun in this record's keywords made the mall outrank «مارينا كريسنت» on
    // its own name. The fact is not lost — it is one line up, in prose.
    highlightsAr: ["مربوط بشاطئ المارينا", "مطاعم على الواجهة", "جسر مشاة للشاطئ"],
  ...
  },
  {
    ...
    // talk about the same waterfront: مارينا مول is connected to this walkway and
    // says so. Once both spelled it the same way, a search for «مارينا كريسنت»
    // ranked the mall first — and شوق reads the top hit aloud, so second place is
    // a wrong answer said confidently.
    tagsAr: ["عشا", "بحر", "مطاعم", "كافيهات", "موعد", "عوائل", "ربع", "ممشى", "كريسنت"],
  },
  {
    slug: "fish-market",
