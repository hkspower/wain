  ...
  return (
    <>
      <button
        ...
        aria-label="بحث"
        className="flex min-h-6 items-center gap-2 rounded-full border border-line-control bg-white/80 px-4 text-sm font-semibold text-ink-500 transition hover:border-sea-300 hover:text-ink-700"
      >
