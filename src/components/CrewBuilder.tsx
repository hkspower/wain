...
export default function CrewBuilder({
  ...
  const swatches = (
    ...
    <div>
      <label className="grn-label text-2xs">{label}</label>
      ...
      <div>
        <div className="flex flex-wrap gap-3">
          <div className="min-w-[12rem] flex-1">
            <label className="grn-label text-2xs">Crew name</label>
            <input
              value={value.name}
          ...
          <div className="w-24">
            <label className="grn-label text-2xs">Tag</label>
            <input
              value={value.tag}
        ...
        <div className="mt-3 flex flex-wrap items-start gap-x-5 gap-y-3">
          <div>
            <label className="grn-label text-2xs">Shape</label>
        ...
        <div className="mt-3">
          <label className="grn-label text-2xs">Emblem</label>
