...
(function (root, factory) {
  ...
  /**
   * يحمي نصًّا لاتينيًّا داخل جملة عربية من انقلاب اتجاهه — مثل أرقام الهواتف
   * وأكواد الطلبات، حيث تقفز علامة + أو # إلى الطرف الخاطئ بدون هذه العلامة.
   */
  function ltr(text) {
    return LRM + String(text);
  }
