...
/* كلام الزبون كما قاله. الوكيل يملأ ما يعرف حقولَه — منطقةً وقطعةً واسمًا
   ورقمًا — وما عدا ذلك كان يسقط بلا أثر: «شارع ٥ منزل ١٢»، «قبل الساعة ٥»،
   «اتصل قبل ما توصل»، «الشحنة كيك لا تقلبها». قِيست أربع رسائل واقعية فسقط
   من كلٍّ منها ما يحتاجه من يوصّل فعلًا.
   والعلاج ليس تخمينَ حقولٍ أكثر — حقلٌ يُملأ خطأً أسوأ من حقلٍ فارغ — بل
   حفظُ النصّ كما هو ليقرأه الموظّف قبل أن يتّصل. */
addOrderColumn('transcript', "TEXT NOT NULL DEFAULT ''");
