...
const orders = [
  ...
  { customer_name: 'دلال المطيري',   customer_phone: '+96599110044', pickup: 'الفروانية، قطعة ١، محل حلا بيتي',                dropoff: 'العارضية، قطعة ٥، منزل ٨',        gov: 'الفروانية',    vehicle: 'reefer', cod: 22,   fee: 2.0,  priority: 'normal', status: 'accepted',   agent: 'fahad',  notes: 'حلويات — الحفاظ على التبريد ضروري' },
  ...
  { customer_name: 'خالد الهاجري',   customer_phone: '+96599110066', pickup: 'الشويخ الصناعية، مستودع رقم ١٧',                 dropoff: 'صباح السالم، قطعة ٩، منزل ٤١',    gov: 'مبارك الكبير', vehicle: 'van',    cod: 145,  fee: 3.5,  priority: 'normal', status: 'assigned',   agent: 'meshari',notes: 'قطعتان كبيرتان — يحتاج مساعدة في التنزيل' },
