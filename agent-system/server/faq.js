...
const SEED = [
  ...
  { id: 'what', q: 'ما موصول؟', keys: ['ايش موصول', 'وش موصول', 'شنو موصول', 'شنهي موصول', 'ما هي موصول', 'من انتم', 'وش تسوون', 'شنو تسوون', 'ايش تقدمون', 'وش خدماتكم'],
  ...
  /* **أقدرُ سؤالٍ على جوابه كان يُحال إلى إنسان.**
     قِيس حوارٌ واقعيّ: سأل الزبون «شنو تبي مني؟» — وهو سؤالٌ عن الوكيل
     نفسه لا عن الشركة — فردّ «ما عندي جواب موثوق عن هذا». والوكيل يعرف
     جوابه بالضبط: أربعة حقول لا غير. والإحالة هنا تقول للزبون إنّ الآلة
     لا تعرف نفسها، فينصرف.
     ولا `handoff` فيه: هذا ما يُكمَل هنا لا ما يُسأل عنه إنسان. */
  { id: 'howto', q: 'كيف أطلب؟ وماذا تحتاج منّي؟',
    keys: ['شنو تبي', 'وش تبي', 'ايش تبي', 'شنو تحتاج', 'وش تحتاج', 'شنو تبي مني',
      'كيف اطلب', 'شلون اطلب', 'كيف اسوي طلب', 'شلون اسوي', 'كيف تشتغلون',
      'شنو الخطوات', 'وش اسوي', 'شنو اسوي', 'ساعدني', 'كيف يشتغل'],
    /* بلا أرقام — ولا رقم هاتفٍ في المثال: حارسُ البذرة يمنع كلّ رقم،
       وأمسك أوّل صياغةٍ لهذا الجواب. والمثال المرقَّم موضعه قوالب السؤال
       في الصفحة («قل مثلًا: رقمي…») حيث يُرى عند الحاجة إليه. */
    a: 'أحتاج أربعة لا غير: من أين نستلم، وإلى أين نوصّل، واسمك، ورقم هاتفك. '
      + 'قلها بجملةٍ واحدة أو واحدةً واحدة، وأسألك عمّا بقي. '
      + 'ثم يراجع المكتب طلبك ويتّصل بك للتأكيد والتسعير قبل أن يتحرّك الكابتن.' },

  { id: 'coverage', q: 'إلى أين تصلون؟', keys: ['وين توصلون', 'المناطق', 'التغطيه', 'تغطون', 'توصلون', 'المحافظات', 'توصلون منطقتي'],
    a: 'نغطّي محافظات الكويت كلها. اذكر منطقة الاستلام ومنطقة التسليم وسنرتّب طلبك.' },
  ...
  { id: 'pay', q: 'ما طرق الدفع؟', keys: ['الدفع', 'ادفع', 'كي نت', 'كاش', 'نقدا', 'طرق الدفع', 'تحويل بنكي', 'فيزا'],
    a: 'نقبل الدفع نقدًا وبكي نت عند الاستلام، والتحويل البنكي للشركات والمتاجر ذات العقود الشهرية.' },
  ...
  { id: 'absent', q: 'ماذا لو لم يكن المستلم موجودًا؟', keys: ['ما احد موجود', 'المستلم مو موجود', 'ما رد', 'لو ما كان موجود', 'ما استلم'],
    a: 'ينتظر الكابتن مدّةً قصيرة ثم يتواصل معك لتحديد الإجراء. وإن تعذّر التسليم تُعاد الشحنة إلى نقطة الاستلام مقابل رسوم.', handoff: true },
  { id: 'store', q: 'كيف أربط متجري بموصول؟', keys: ['متجري', 'المتجر', 'ربط', 'api', 'واجهه برمجيه', 'شوبيفاي', 'سله', 'زد'],
    a: 'نوفّر واجهة برمجية وإضافات لمنصّات المتاجر الشائعة. اترك رقمك ويتّصل بك المكتب لبدء الربط.', handoff: true },
  { id: 'cold', q: 'هل يوجد توصيل مبرّد؟', keys: ['مبرد', 'تبريد', 'ثلاجه', 'مواد غذاءيه', 'ادويه', 'حلويات'],
    a: 'نعم، لدينا خيار السيارة المبرّدة للمواد الغذائية الطازجة والحلويات والأدوية التي تحتاج إلى سلسلة تبريد. اذكر أنك تريد سيارة مبرّدة في طلبك.' },
  ...
  { id: 'join', q: 'كيف أنضمّ كابتنًا؟', keys: ['ابغى اشتغل', 'ابي اشتغل', 'اشتغل معكم', 'اشتغل كابتن', 'انضم', 'انضم لكم', 'وظيفه', 'التسجيل كساءق', 'ابغى اصير كابتن'],
    a: 'يُشترط للانضمام أن تملك سيارتك الخاصة وأن تكون حديثة الموديل، وأن تجتاز مقابلة شخصية قبل الاعتماد. اترك رقمك ويتواصل معك المكتب.', handoff: true },
  { id: 'hours', q: 'ما أوقات العمل؟', keys: ['متى تشتغلون', 'الدوام', 'اوقات العمل', 'تشتغلون الجمعه', 'تفتحون'],
    a: 'نعمل يوميًا. إن كان طلبك خارج أوقات الدوام فأرسله على أيّ حال ويتواصل معك المكتب.', handoff: true },
...
const FALLBACK =
  'ما عندي جواب موثوق عن هذا، ولا أحبّ أن أخمّن. '
...
function ensureSeed() {
  ...
  /**
   * تحديث المبذور الذي **لم يمسسه المكتب**.
   *
   * البذر كان يقع مرّةً ثمّ يتجمّد النصّ إلى الأبد. فخطأٌ لغويّ في جوابٍ
   * مبذور لا يصل تصحيحُه أحدًا: نصلحه في الشيفرة، وتبقى القاعدة القائمة
   * على خطئها — والزبون يقرأ الخطأ لا التصحيح. صُحّحت هنا أخطاء نحوٍ
   * وإملاء («يُشترط للانضمام» بدل «الانضمام يشترط»، و«تحتاج إلى» بدل
   * «تحتاج»)، ولولا هذا لما رآها إلّا من نصّب النظام اليوم.
   *
   * وما حرّره المكتب لا يُمسّ: تحريرُه يضع `updated_by` ويحرّك `updated_at`
   * عن `created_at`، فالصفّ البِكر يُعرف بهما. وإتلاف كلمةٍ كتبها المكتب
   * أسوأ من إبقاء خطأٍ كتبناه نحن.
   */
  const refresh = db.prepare(
    `UPDATE faq SET question = ?, answer = ?, keys = ?, handoff = ?
      WHERE seed_id = ? AND updated_by IS NULL AND updated_at = created_at`
  );
  const run = db.transaction(() => {
    ...
    for (const s of SEED) {
      ...
      if (done.get(s.id)) { refresh.run(s.q, s.a, s.keys.join('\n'), s.handoff ? 1 : 0, s.id); continue; }
