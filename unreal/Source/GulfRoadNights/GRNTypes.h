...
static const FGRNCarDef GRNCars[] = {
	{ TEXT("black-demon"), TEXT("Black Demon"), 420000, 1.85f, 415.0f, 17.2f, 44.0f, FColor(0x0B, 0x0A, 0x0D), EGRNBodyStyle::GTR, true, GRNSim::EDrivetrain::RWD, 4, 82.0f, 4.66f, 2.60f, 8, TEXT("zeta-300-gtr"), TEXT("twin-turbo,intake,ecu,exhaust-ti,brakes-carbon,tires-slick,lsd,coilovers,cage,rack,weight,nos") },
	{ TEXT("zeta-300-gtr"), TEXT("Zeta 300 GTR"), 240000, 1.70f, 405.0f, 18.0f, 46.0f, FColor(0x3B, 0x2A, 0x5A), EGRNBodyStyle::ZX, true, GRNSim::EDrivetrain::AWD, 3, 70.0f, 4.53f, 2.40f, 8, TEXT(""), TEXT("twin-turbo,intake,ecu,exhaust-ti,brakes-carbon,tires-slick,lsd,coilovers,cage,rack,weight,nos") },
	{ TEXT("efreet-rx-kai"), TEXT("Efreet RX Kai"), 120000, 1.66f, 400.0f, 17.5f, 44.0f, FColor(0xF2, 0xB9, 0x0D), EGRNBodyStyle::RX7, true, GRNSim::EDrivetrain::RWD, 3, 55.0f, 4.42f, 3.00f, 0, TEXT(""), TEXT("") },
	{ TEXT("sahara-v12"), TEXT("Sahara V12"), 96000, 1.62f, 385.0f, 16.4f, 42.0f, FColor(0xB8, 0x86, 0x0B), EGRNBodyStyle::ZX, true, GRNSim::EDrivetrain::RWD, 4, 90.0f, 4.62f, 3.20f, 0, TEXT(""), TEXT("") },
	{ TEXT("falcon-720"), TEXT("Falcon 720"), 71000, 1.50f, 360.0f, 15.8f, 40.0f, FColor(0xC1, 0x12, 0x1F), EGRNBodyStyle::ZX, true, GRNSim::EDrivetrain::RWD, 4, 72.0f, 4.54f, 3.40f, 0, TEXT(""), TEXT("") },
	{ TEXT("storm-s8"), TEXT("Storm S8"), 54000, 1.40f, 335.0f, 15.2f, 38.0f, FColor(0x1F, 0x29, 0x33), EGRNBodyStyle::Super, true, GRNSim::EDrivetrain::AWD, 3, 68.0f, 4.80f, 3.80f, 0, TEXT(""), TEXT("") },
	{ TEXT("anniversary-30"), TEXT("Bareed 30 Anniversary"), 35000, 1.31f, 300.0f, 12.4f, 33.0f, FColor(0xF2, 0xF2, 0xEE), EGRNBodyStyle::Pony, false, GRNSim::EDrivetrain::RWD, 4, 61.0f, 4.92f, 4.80f, 0, TEXT(""), TEXT("") },
	{ TEXT("kaiju-r"), TEXT("Kaiju R"), 38000, 1.34f, 310.0f, 16.2f, 38.0f, FColor(0x3F, 0x66, 0xC4), EGRNBodyStyle::GTR, true, GRNSim::EDrivetrain::AWD, 3, 74.0f, 4.60f, 4.40f, 0, TEXT(""), TEXT("") },
	{ TEXT("efreet-rx"), TEXT("Efreet RX"), 31000, 1.30f, 295.0f, 14.8f, 35.0f, FColor(0xD7, 0x26, 0x3D), EGRNBodyStyle::RX7, false, GRNSim::EDrivetrain::RWD, 2, 60.0f, 4.30f, 5.20f, 0, TEXT(""), TEXT("") },
	{ TEXT("zeta-300"), TEXT("Zeta 300"), 27000, 1.26f, 275.0f, 13.9f, 34.0f, FColor(0xC1, 0x27, 0x2D), EGRNBodyStyle::ZX, false, GRNSim::EDrivetrain::AWD, 3, 70.0f, 4.31f, 5.80f, 0, TEXT(""), TEXT("") },
	{ TEXT("gulf-coupe-rs"), TEXT("Gulf Coupe RS"), 33000, 1.28f, 285.0f, 14.6f, 35.0f, FColor(0xCB, 0x20, 0x27), EGRNBodyStyle::Hatch, false, GRNSim::EDrivetrain::FWD, 1, 50.0f, 4.28f, 5.60f, 0, TEXT(""), TEXT("") },
	{ TEXT("salmiya-turbo"), TEXT("Salmiya Turbo GT"), 24000, 1.20f, 255.0f, 13.8f, 32.0f, FColor(0xB8, 0x4D, 0xD6), EGRNBodyStyle::Sedan, false, GRNSim::EDrivetrain::FWD, 1, 60.0f, 4.64f, 6.60f, 0, TEXT(""), TEXT("") },
	{ TEXT("hawally-2t"), TEXT("Hawally Sport 2T"), 16000, 1.12f, 240.0f, 13.2f, 30.0f, FColor(0xF5, 0xC2, 0x11), EGRNBodyStyle::Sedan, false, GRNSim::EDrivetrain::FWD, 1, 55.0f, 4.56f, 8.20f, 0, TEXT(""), TEXT("") },
	{ TEXT("deera-sedan"), TEXT("Deera Sedan"), 8500, 1.05f, 220.0f, 12.6f, 28.0f, FColor(0xDF, 0xE3, 0xE8), EGRNBodyStyle::Sedan, false, GRNSim::EDrivetrain::FWD, 1, 60.0f, 4.70f, 9.50f, 0, TEXT(""), TEXT("") },
	{ TEXT("jahra-pickup"), TEXT("Jahra Pickup"), 6000, 1.00f, 195.0f, 12.0f, 27.0f, FColor(0x6E, 0x7F, 0x8D), EGRNBodyStyle::Pickup, false, GRNSim::EDrivetrain::RWD, 4, 80.0f, 5.16f, 8.00f, 0, TEXT(""), TEXT("") },
	{ TEXT("sharq-hatch"), TEXT("Sharq Hatch"), 2200, 0.98f, 205.0f, 12.4f, 27.0f, FColor(0x16, 0xA3, 0x4A), EGRNBodyStyle::Hatch, false, GRNSim::EDrivetrain::FWD, 0, 42.0f, 3.95f, 10.80f, 0, TEXT(""), TEXT("") },
	{ TEXT("wain-special"), TEXT("Wain Special"), 0, 1.00f, 180.0f, 12.0f, 26.0f, FColor(0xF2, 0xF4, 0xF7), EGRNBodyStyle::Sedan, false, GRNSim::EDrivetrain::RWD, 0, 50.0f, 4.45f, 11.50f, 0, TEXT(""), TEXT("") },
};
