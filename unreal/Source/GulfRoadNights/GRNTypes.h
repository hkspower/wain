...
static const FGRNCarDef GRNCars[] = {
	...
	{ TEXT("storm-s8"), TEXT("Storm S8"), 54000, 1.40f, 335.0f, 15.2f, 38.0f, FColor(0x1F, 0x29, 0x33), EGRNBodyStyle::Super, true, GRNSim::EDrivetrain::AWD, 3, 68.0f, 4.80f, 0, TEXT(""), TEXT("") },
