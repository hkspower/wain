...
static const FGRNCarDef GRNCars[] = {
	...
	{ TEXT("jahra-pickup"), TEXT("Jahra Pickup"), 6000, 1.00f, 195.0f, 12.0f, 27.0f, FColor(0x6E, 0x7F, 0x8D), EGRNBodyStyle::Sedan, false, GRNSim::EDrivetrain::RWD, 4, 80.0f, 5.16f, 0, TEXT(""), TEXT("") },
