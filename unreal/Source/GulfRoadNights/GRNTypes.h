...
static const FGRNCarDef GRNCars[] = {
	...
	{ TEXT("sahara-v12"), TEXT("Sahara V12"), 96000, 1.62f, 385.0f, 16.4f, 42.0f, FColor(0xB8, 0x86, 0x0B), EGRNBodyStyle::ZX, true, GRNSim::EDrivetrain::RWD, 4, 90.0f, 4.62f, 0, TEXT("") },
	{ TEXT("falcon-720"), TEXT("Falcon 720"), 71000, 1.50f, 360.0f, 15.8f, 40.0f, FColor(0xC1, 0x12, 0x1F), EGRNBodyStyle::ZX, true, GRNSim::EDrivetrain::RWD, 4, 72.0f, 4.54f, 0, TEXT("") },
	{ TEXT("storm-s8"), TEXT("Storm S8"), 54000, 1.40f, 335.0f, 15.2f, 38.0f, FColor(0x1F, 0x29, 0x33), EGRNBodyStyle::Sedan, true, GRNSim::EDrivetrain::AWD, 3, 68.0f, 4.80f, 0, TEXT("") },
	...
	{ TEXT("hawally-2t"), TEXT("Hawally Sport 2T"), 16000, 1.12f, 240.0f, 13.2f, 30.0f, FColor(0xF5, 0xC2, 0x11), EGRNBodyStyle::Sedan, false, GRNSim::EDrivetrain::FWD, 1, 55.0f, 4.56f, 0, TEXT("") },
