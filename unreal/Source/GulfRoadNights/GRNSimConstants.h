...
namespace GRNRig
{
	...
	constexpr float PlantShrubK = 160.f;
	constexpr float PlantShrubC = 9.f;
	constexpr float PlantPalmK = 25.f;
	constexpr float PlantPalmC = 3.5f;
	constexpr float PlantMaxLean = 0.9f;
	constexpr float PlantGustBase = 0.05f;
	constexpr float PlantGustAmp = 0.03f;
	constexpr float PlantGustRate = 0.37f;
	constexpr float PlantWindTurnRate = 0.05f;
	constexpr float PlantWindK = 0.5f;
	constexpr float PlantSwayHz = 0.14f;
	constexpr float PlantSwayK = 0.5f;
	constexpr float PlantFrontAmp = 0.6f;
	constexpr float PlantFrontRate = 0.6f;
	constexpr float PlantFrontK = 0.08f;
	constexpr float PlantWakeR = 9.f;
	constexpr float PlantWakeRefSpeed = 55.f;
	constexpr float PlantWakeK = 0.55f;
	constexpr float PlantNoseM = 3.f;
	constexpr float PlantSuctionK = 0.3f;
	constexpr float PlantDragK = 0.25f;
	constexpr float PlantTailLenM = 12.f;
	constexpr float PlantPalmWakeK = 0.35f;
	constexpr float PlantArcDrop = 0.5f;
	constexpr float PlantNormalGain = 0.8f;
