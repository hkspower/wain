...
namespace GRNHandling
{
	...
	constexpr float ShiftUpTime = 0.22f;
	...
	constexpr float TowDirtyAir = 0.06f;
	constexpr float TowMinSpeed = 8.f;
	constexpr float TowFullSpeed = 30.f;
	constexpr float TowDefaultHalfWidth = 0.9f;
	constexpr float TowEdgeSpread = 0.9f;
...
namespace GRNExact
{
	...
	constexpr double ShiftUpTime = 0.22;
	...
	constexpr double TowDirtyAir = 0.06;
	constexpr double TowMinSpeed = 8;
	constexpr double TowFullSpeed = 30;
	constexpr double TowDefaultHalfWidth = 0.9;
	constexpr double TowEdgeSpread = 0.9;
...
namespace GRNRig
{
	...
	constexpr float DriverLeanRefAccel = 14.f;
	constexpr float DriverFoldRefAccel = 10.f;
	constexpr float DriverFoldSpikeK = 2.5f;
	constexpr float DriverTorsoK = 190.f;
	constexpr float DriverTorsoC = 15.f;
	constexpr float DriverNeckK = 355.f;
	...
	constexpr float DriverPedalClutchX = 0.21f;
	constexpr float DriverPedalRestX = 0.31f;
	constexpr float DriverFootSwapRate = 14.f;
	constexpr float DriverHeelToeReach = 0.45f;
	constexpr float DriverHeelToeBrake = 0.2f;
	constexpr float DriverClutchRate = 20.f;
	...
	constexpr float DriverGripCarryMax = 1.05f;
	constexpr float DriverHandbrakeX = -0.3f;
	constexpr float DriverHandbrakeY = 0.16f;
	constexpr float DriverHandbrakeZ = 0.02f;
	constexpr float DriverHandbrakeLen = 0.26f;
